...
function AdminEventsViewPage() {
    ...
    return (
        <div className="p-6 bg-white rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold mb-6 text-blue-500">Gestion des événements</h2>
            <div className="grid gap-4">
                {events.map((event) => (
                    <div key={event.id} className="border p-4 rounded-lg flex justify-between items-center">
                        <div>
