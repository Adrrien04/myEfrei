...
const AdminNewsViewPage = () => {
    const [articles, setArticles] = useState<{ id: number; title: string; content: string; image_url: string | null }[]>([]);
    const { isOpen, openModal, closeModal, selectedItem, maxHeight } = useModal();
    const [isEditing, setIsEditing] = useState(false);
    const [editArticle, setEditArticle] = useState<{ id: number; title: string; content: string; image_url: string | null } | null>(null);
    ...
    const handleEdit = (article: { id: number; title: string; content: string; image_url: string | null }) => {
        setIsEditing(true);
